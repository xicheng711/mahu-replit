...
const styles = StyleSheet.create({
  ...
  welcomeIconBg: { width: 130, height: 130, borderRadius: 36, overflow: 'hidden', alignItems: 'center', justifyContent: 'center', shadowColor: '#C084FC', shadowOffset: { width: 0, height: 4 }, shadowOpacity: 0.15, shadowRadius: 12, elevation: 6 },
