...
export const ENCOURAGEMENTS = {
  // 情绪分数 1-3（低落）
  low: [
    '今天辛苦了。照顾老人本就不容易，能坚持到现在，您已经很了不起了。💙',
    '感到疲惫是正常的。您付出的每一分爱，老人都感受得到，哪怕他们说不出来。',
    '允许自己今天休息一下。照顾好自己，才能更好地照顾老人。🌙',
    '您不是一个人在战斗。每一个照顾者都有脆弱的时候，这不是软弱，是人之常情。',
    '今天的难关会过去的。明天又是新的一天，您一定可以的。🌅',
  ],
  // 情绪分数 4-6（一般）
  medium: [
    '今天的您，已经做得很好了。继续加油！🌟',
    '每天的坚持，都是对老人最深的爱。您是家里的英雄。❤️',
    '照顾老人的路上有起伏，但您的付出都是有意义的。',
    '记得给自己一个小奖励，您值得被善待。🍵',
    '您的陪伴，是老人最大的安慰。谢谢您每天的守护。🌸',
  ],
  // 情绪分数 7-10（良好）
  high: [
    '今天状态不错！把这份好心情传递给老人吧！😊',
    ...
    '您做到了！今天的您，闪闪发光。🌟',
    '看到您这么积极，老人一定也感受到了家的温暖。太棒了！🎉',
  ],
  // 完成每日打卡后的专属鼓励
  checkinComplete: [
    '打卡完成！今天的记录已保存。您对老人的用心，都藏在这些小小的记录里。🐾',
    '太棒了！每天坚持记录，您就是最称职的照顾者！✅',
    '今日打卡成功！小马虎为您点赞！🐴🐯',
    '记录完成！这些珍贵的日常，都是爱的痕迹。💕',
    '完成！您今天的守护，老人都感受到了。继续加油！🌈',
  ],
};
