...
- **Care Analysis Page**: Unified `share.tsx` for daily record analysis, including header card, 5-grid badges, AI summary, sleep detail (donut chart), and weekly bar chart.
